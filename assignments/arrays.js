...
// ==== Challenge 1 ====
// The dealer can't recall the information for a car with an id of 33 on his lot. Help the dealer find out which car has an id of 33 by 
...
console.log('Make of the last car is ' +inventory[lastCar] ['car_make']+' '+'Model of last car is ' +inventory[lastCar]['car_model']);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order 
...
// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only
// the car years and log the result in the console.
let carYears = [];
for (let i=0;i<inventory.length;i++){
...
// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000.Using the carYears array you just created, 
